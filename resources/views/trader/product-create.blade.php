...
<div class="max-w-6xl">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            <form id="product-form" action="{{ route('trader.product.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-surface-container-lowest border border-surface-container-high border-dashed rounded-lg p-8">
                <h4 class="text-sm font-bold text-on-background mb-4">Visual Identity</h4>
            ...
            <div class="bg-primary text-on-primary rounded-xl p-8 space-y-4">
                ...
                <button type="submit" form="product-form" class="w-full bg-white text-primary font-bold py-3 px-4 rounded-full hover:opacity-90 transition-all uppercase tracking-widest text-sm">
                    Publish Product
                </button>
