            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex gap-4">
                    ...
                    @else
                        ...
                        <button onclick="openSignupModal()" class="font-['Plus_Jakarta_Sans'] uppercase tracking-[0.05em] text-[12px] font-bold text-white bg-red-600 px-6 py-2 rounded-full hover:bg-red-700 transition-all">Sign Up</button>
                    @endauth
                </div>
            </div>
        </div>
