...
<head>
    ...
    <title>Login | Click and Collect</title>
    <!-- Material Symbols -->
...
<div class="min-h-screen flex flex-col md:flex-row">
    ...
    <div class="hidden md:flex md:w-1/2 lg:w-3/5 bg-on-background relative overflow-hidden items-center justify-center p-12">
        ...
        <div class="relative z-10 max-w-xl">
            ...
            <p class="text-surface-variant text-xl leading-relaxed max-w-md font-light">
                The intersection of local artisan craft and modern digital convenience. Welcome to the neighborhood, elevated.
            </p>
            <div class="mt-16 grid grid-cols-2 gap-8">
                <div class="bg-surface-container-highest/5 backdrop-blur-sm p-8 rounded-lg">
                    <span class="material-symbols-outlined text-primary-fixed mb-4" data-icon="local_mall">local_mall</span>
                    <h3 class="text-surface font-headline font-bold text-lg">Curated Shops</h3>
                    <p class="text-surface-variant text-sm mt-2">Only the finest local vendors make our selection.</p>
                </div>
                <div class="bg-surface-container-highest/5 backdrop-blur-sm p-8 rounded-lg">
                    <span class="material-symbols-outlined text-primary-fixed mb-4" data-icon="speed">speed</span>
                    <h3 class="text-surface font-headline font-bold text-lg">Instant Ready</h3>
                    <p class="text-surface-variant text-sm mt-2">Pick up at your convenience, no waiting required.</p>
                </div>
            </div>
        </div>
        ...
        <div class="absolute bottom-12 right-12 w-64 h-80 rounded-xl overflow-hidden shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-500 hidden lg:block">
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-on-background/80 to-transparent flex flex-col justify-end p-6">
                <p class="text-white text-xs uppercase tracking-widest font-bold">Local Spotlight</p>
                <p class="text-surface-variant text-sm">The Heritage Co.</p>
            </div>
        </div>
    </div>
    ...
    <main class="w-full md:w-1/2 lg:w-2/5 flex flex-col justify-center px-6 py-12 lg:px-24 bg-surface">
        ...
        <div class="w-full max-w-md mx-auto">
            <header class="mb-10">
                <h2 class="font-headline text-4xl font-bold text-on-background tracking-tight">Sign In</h2>
                <p class="text-on-surface-variant mt-2">Enter your credentials to access your portal.</p>
            </header>
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between items-end ml-1">
                        <label class="block text-[10px] font-bold uppercase tracking-[0.1em] text-on-surface-variant" for="password">
                            Password
                        </label>
            ...
            <div class="relative my-12">
                ...
                <div class="relative flex justify-center">
                    <span class="px-4 bg-surface text-[10px] font-bold uppercase tracking-[0.2em] text-outline">or continue with</span>
                </div>
            </div>
            ...
            <footer class="mt-12 text-center">
                <p class="text-on-surface-variant font-medium">
                    ...
                    @if (Route::has('register'))
                        <a class="text-primary font-bold hover:underline decoration-2 underline-offset-4 ml-1" href="{{ route('register') }}">Sign up for free</a>
                    @endif
                </p>
            </footer>
        </div>
